...
----------------------------------------------------------------------------------------------------------------------------------------------
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/TeamKsa/nah/main/nahui.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/TeamKsa/nah/main/nahmanager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/TeamKsa/nah/main/nahface.lua"))()
----------------------------------------------------------------------------------------------------------------------------------------------
...
warn("لقد تم كشفك انك تستخدم هاك")
